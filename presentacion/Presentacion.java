...
public class Presentacion {
	...
	public static void main(String[] args) {
		...
		// Agregar datosComida a productos
		productos.addAll(Arrays.asList(datosComida));
		Restaurante tienda = new Restaurante("Cocina con Sarah", productos, clientes);
					...
					case 1:
						...
						if (Validar(nombreCliente)) {
							...
							do {
								...
								int compra = entrada.nextInt(); entrada.nextLine();
								...
								if (compra >= 0 && compra < productos.size()) {
									...
									do {
										...
										try {
											cantidades = entrada.nextInt(); entrada.nextLine();
